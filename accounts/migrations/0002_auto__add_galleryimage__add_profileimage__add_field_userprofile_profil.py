...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.profile_image_cropped'
        db.add_column('accounts_userprofile', 'profile_image_cropped', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='profile_image_cropped', unique=True, null=True, to=orm['accounts.ProfileImage']), keep_default=False)

        # Adding field 'UserProfile.profile_image_uncropped'
        db.add_column('accounts_userprofile', 'profile_image_uncropped', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='profile_image_uncropped', unique=True, null=True, to=orm['accounts.ProfileImage']), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'UserProfile.profile_image_cropped'
        db.delete_column('accounts_userprofile', 'profile_image_cropped_id')

        # Deleting field 'UserProfile.profile_image_uncropped'
        db.delete_column('accounts_userprofile', 'profile_image_uncropped_id')
