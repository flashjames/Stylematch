...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.temporary_profile_url'
        db.add_column('accounts_userprofile', 'temporary_profile_url', self.gf('django.db.models.fields.CharField')(default='', unique=True, max_length=36), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.temporary_profile_url'
        db.delete_column('accounts_userprofile', 'temporary_profile_url')
