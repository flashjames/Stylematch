$(window).load(function(){
    ...
    var padding_x_coordinate = 0; var padding_y_coordinate = 0; var bound = 0;
	...
	padding_x_coordinate = (($('#jcrop_target').width()-bound)/2);
    } else {
	bound = bound_width;
	// used to center the selection box
	padding_y_coordinate = (($('#jcrop_target').height()-bound)/2);
    }
     ...
     */
    jcrop_api.setSelect([0+padding_x_coordinate,0+padding_y_coordinate,bound+padding_x_coordinate,bound+padding_y_coordinate]);
