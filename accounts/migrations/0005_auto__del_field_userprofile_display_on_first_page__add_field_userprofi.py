...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'UserProfile.display_on_first_page'
        db.delete_column('accounts_userprofile', 'display_on_first_page')

        # Adding field 'UserProfile.visible'
        db.add_column('accounts_userprofile', 'visible', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'UserProfile.display_on_first_page'
        db.add_column('accounts_userprofile', 'display_on_first_page', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Deleting field 'UserProfile.visible'
        db.delete_column('accounts_userprofile', 'visible')
