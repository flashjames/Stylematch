...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('accounts_userprofile', 'latitude', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=18, decimal_places=10), keep_default=False)

        # Adding field 'UserProfile.longitude'
        db.add_column('accounts_userprofile', 'longitude', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=18, decimal_places=10), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.latitude'
        db.delete_column('accounts_userprofile', 'latitude')

        # Deleting field 'UserProfile.longitude'
        db.delete_column('accounts_userprofile', 'longitude')
    ...
    models = {
        ...
        'accounts.userprofile': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'latitude': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '18', 'decimal_places': '10'}),
            'longitude': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '18', 'decimal_places': '10'}),
