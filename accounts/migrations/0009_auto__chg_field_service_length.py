...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Service.length'
        db.alter_column('accounts_service', 'length', self.gf('django.db.models.fields.IntegerField')(max_length=3))


    def backwards(self, orm):
        
        # Changing field 'Service.length'
        db.alter_column('accounts_service', 'length', self.gf('django.db.models.fields.FloatField')(max_length=6))
