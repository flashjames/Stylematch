...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_table('accounts_invitecode', (
            ...
            ('inviter', self.gf('django.db.models.fields.related.ForeignKey')(related_name='invitecode_inviter', null=True, to=orm['auth.User'], blank=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('reciever', self.gf('django.db.models.fields.related.ForeignKey')(related_name='invitecode_reciever', null=True, to=orm['auth.User'], blank=True)),
        ))
