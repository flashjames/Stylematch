...
(function($) {
	$.noty = function(options, customContainer) {
		...
		base.render = function(isGrowl) {
			...
			var container = (isCustom) ? customContainer.addClass(base.options.theme+' '+base.options.layout+' noty_custom_container') : $('div.authed');
	  	if (isGrowl) {
		...
		base.show = function(isGrowl) {
			...
			(isGrowl) ? base.container.append($('<li/>').append($noty)) : base.container.append($noty);
