...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'InspirationVote'
        db.create_table('index_inspirationvote', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('image', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.GalleryImage'])),
            ('datetime', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('index', ['InspirationVote'])


    def backwards(self, orm):
        
        # Deleting model 'InspirationVote'
        db.delete_table('index_inspirationvote')
    ...
    models = {
        ...
        'index.inspirationvote': {
            'Meta': {'object_name': 'InspirationVote'},
            'datetime': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['accounts.GalleryImage']"})
        },
        'index.tip': {
