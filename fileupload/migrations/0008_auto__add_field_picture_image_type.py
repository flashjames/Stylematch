...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('fileupload_picture', 'image_type', self.gf('django.db.models.fields.CharField')(default='', max_length=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Picture.image_type'
        db.delete_column('fileupload_picture', 'image_type')
