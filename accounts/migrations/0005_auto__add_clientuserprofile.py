...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ClientUserProfile'
        db.create_table('accounts_clientuserprofile', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
            ('phone_number', self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True)),
        ))
        db.send_create_signal('accounts', ['ClientUserProfile'])


    def backwards(self, orm):
        
        # Deleting model 'ClientUserProfile'
        db.delete_table('accounts_clientuserprofile')


    models = {
        'accounts.clientuserprofile': {
            'Meta': {'object_name': 'ClientUserProfile'},
