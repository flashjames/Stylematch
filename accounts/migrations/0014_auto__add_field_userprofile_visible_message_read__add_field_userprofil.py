...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.visible_message_read'
        db.add_column('accounts_userprofile', 'visible_message_read', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'UserProfile.approved_message_read'
        db.add_column('accounts_userprofile', 'approved_message_read', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.visible_message_read'
        db.delete_column('accounts_userprofile', 'visible_message_read')

        # Deleting field 'UserProfile.approved_message_read'
        db.delete_column('accounts_userprofile', 'approved_message_read')
