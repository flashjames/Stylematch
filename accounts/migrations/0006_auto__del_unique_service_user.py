...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'Service', fields ['user']
        db.delete_unique('accounts_service', ['user_id'])


    def backwards(self, orm):
        
        # Adding unique constraint on 'Service', fields ['user']
        db.create_unique('accounts_service', ['user_id'])
