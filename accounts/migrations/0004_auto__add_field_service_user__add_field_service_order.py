...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Service.user'
        db.add_column('accounts_service', 'user', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['auth.User'], unique=True), keep_default=False)

        # Adding field 'Service.order'
        db.add_column('accounts_service', 'order', self.gf('django.db.models.fields.PositiveIntegerField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Service.user'
        db.delete_column('accounts_service', 'user_id')

        # Deleting field 'Service.order'
        db.delete_column('accounts_service', 'order')
