...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('accounts_userprofile', (
            ...
            ('profile_name', self.gf('django.db.models.fields.CharField')(max_length=40, blank=True)),
            ('profile_phone_number', self.gf('django.db.models.fields.CharField')(max_length=30, blank=True)),
            ('profile_text', self.gf('django.db.models.fields.CharField')(max_length=500, blank=True)),
            ('profile_url', self.gf('django.db.models.fields.CharField')(max_length=15, blank=True)),
            ...
            ('salon_phone_number', self.gf('django.db.models.fields.CharField')(max_length=30, blank=True)),
            ('zip_adress', self.gf('django.db.models.fields.IntegerField')(max_length=6, null=True, blank=True)),
        ...
        db.create_table('accounts_service', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('length', self.gf('django.db.models.fields.FloatField')(max_length=6)),
