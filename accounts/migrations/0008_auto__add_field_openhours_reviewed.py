...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'OpenHours.reviewed'
        db.add_column('accounts_openhours', 'reviewed', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'OpenHours.reviewed'
        db.delete_column('accounts_openhours', 'reviewed')
