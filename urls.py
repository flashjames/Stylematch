...
urlpatterns += patterns(
    ...
    (r'^om-oss/',
     ...
     {},
     'about_us_page'),
    (u'^om-stylematch/frisör',
     TemplateView.as_view(template_name="about_stylematch_frisor.html"),
     {},
     'about_hairdresser_page'),
    (r'^om-stylematch/privatperson',
     TemplateView.as_view(template_name="about_stylematch_privatperson.html"),
     {},
     'about_private_page'),
    (r'^jobb/',
    ...
    (u'^frisör/',
            ...
            'frisor_page'),
    (r'^fris/$',
            RedirectView.as_view(url="/frisör/"),
            {},
            'frisor_page_redirect'),
    (u'^faq-frisör/',
